...
$(".avatarRow").click(function(){
	if (($("#playerTwo").find('img').length)){
		...
		if(firstPlayerSelected === false){
			...
			$('#playerOne').append('<div class="progress progress-attacker"> <div class="progress-bar" id="attackerHealth" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"> '+ pOneHealth + "%" +' </div> </div>')
			...
			$('#playerTwo').append('<div class="progress progress-defender"> <div class="progress-bar " id="defenderHealth" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"> '+ pTwoHealth + "%" +' </div> </div>')
